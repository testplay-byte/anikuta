...
import app.anikuta.domain.track.anime.model.toDbTrack
import app.anikuta.domain.track.anime.service.DelayedAnimeTrackingUpdateJob
import app.anikuta.domain.track.anime.store.DelayedAnimeTrackingStore
...
import app.anikuta.data.track.AnimeTracker
...
import app.anikuta.util.system.LocaleHelper
import app.anikuta.util.system.isOnline
// TODO: toast
...
import app.anikuta.domain.track.anime.interactor.InsertAnimeTrack
...
class ExternalIntents {
    ...
    private suspend fun makeErrorToast(context: Context, e: Exception?) {
        withContext(Dispatchers.Main) { context.toast(e?.message ?: "Cannot open episode") }
    }
