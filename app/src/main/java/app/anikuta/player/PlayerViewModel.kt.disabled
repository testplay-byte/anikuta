...
import app.anikuta.domain.base.BasePreferences
import app.anikuta.domain.entries.anime.interactor.SetAnimeViewerFlags
import app.anikuta.domain.items.episode.model.toDbEpisode
import app.anikuta.domain.source.anime.interactor.GetAnimeIncognitoState
import app.anikuta.domain.track.anime.interactor.TrackEpisode
import app.anikuta.domain.track.service.TrackPreferences
import app.anikuta.domain.ui.UiPreferences
// TODO: // TODO: CustomButtonFetchState
// TODO: // TODO: getButtons
...
import app.anikuta.source.api.model.SerializableHoster.Companion.toHosterList
...
import app.anikuta.data.database.models.anime.isRecognizedNumber
import app.anikuta.data.database.models.anime.toDomainEpisode
import app.anikuta.data.database.models.manga.isRecognizedNumber
import app.anikuta.data.download.anime.AnimeDownloadManager
import app.anikuta.data.download.anime.model.AnimeDownload
import app.anikuta.data.saver.Image
import app.anikuta.data.saver.ImageSaver
import app.anikuta.data.saver.Location
...
import app.anikuta.player.loader.HosterLoader
import app.anikuta.player.settings.GesturePreferences
import app.anikuta.player.settings.PlayerPreferences
import app.anikuta.player.utils.AniSkipApi
import app.anikuta.player.utils.ChapterUtils.Companion.getStringRes
import app.anikuta.player.utils.TrackSelect
// TODO: SaveImageNotifier
import app.anikuta.util.editBackground
import app.anikuta.util.editCover
import app.anikuta.util.editThumbnail
import app.anikuta.util.episode.filterDownloadedEpisodes
import app.anikuta.util.lang.byteSize
import app.anikuta.util.lang.takeBytes
import app.anikuta.util.storage.DiskUtil
import app.anikuta.util.storage.cacheImageDir
// TODO: toast
...
import app.anikuta.domain.custombuttons.interactor.GetCustomButtons
...
import app.anikuta.domain.items.episode.service.getEpisodeSort
...
import app.anikuta.domain.track.anime.interactor.GetAnimeTracks
// TODO: MR
// TODO: AYMR
    ...
    fun loadTracks() {
        ...
        trackLoadingJob = viewModelScope.launch {
            ...
            val audioTracks = mutableListOf(
                VideoTrack(-1, activity.stringResource("TODO"), null),
            )
            try {
                ...
                Log.d("Player", "Couldn't load tracks, probably cause mpv was destroyed")
                return@launch
            }
