package app.anikuta.player.loader

import app.anikuta.domain.items.episode.model.toSEpisode
import app.anikuta.source.api.AnimeSource
import app.anikuta.source.api.model.Hoster
import app.anikuta.source.api.model.Hoster.Companion.toHosterList
import app.anikuta.source.api.model.Video
import app.anikuta.source.api.online.AnimeHttpSource
import app.anikuta.source.api.online.ParsedAnimeHttpSource
