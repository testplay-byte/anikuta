package app.anikuta.domain.mihon.items.chapter.interactor

import app.anikuta.domain.category.manga.interactor.GetMangaCategories
import app.anikuta.domain.download.service.DownloadPreferences
import app.anikuta.domain.entries.manga.model.Manga
import app.anikuta.domain.items.chapter.interactor.GetChaptersByMangaId
